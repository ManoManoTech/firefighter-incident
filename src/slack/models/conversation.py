...
if TYPE_CHECKING:
    ...
    from slack.models.message import MessageManager
...
class Conversation(models.Model):
    ...
    objects: ConversationManager[Conversation] = ConversationManager["Conversation"]()
