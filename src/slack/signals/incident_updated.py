...
from incidents.signals import incident_key_events_updated, incident_updated
from slack.messages.slack_messages import (
...
from slack.models.conversation import Conversation, ConversationType
from slack.rules import (
...
def incident_key_events_updated_handler(
    ...
    **kwargs: Any,
    ...
    from slack.views.modals.key_event_message import (  # noqa: PLC0415
