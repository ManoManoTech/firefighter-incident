...
from firefighter.utils import is_during_office_hours
...
from slack.slack_incident_context import get_user_from_context
from slack.views.modals.base_modal.base import SlackModal
from slack.views.modals.base_modal.form_utils import SlackFormJSONEncoder
from slack.views.modals.base_modal.modal_utils import update_modal
from slack.views.modals.opening.check_current_incidents import (
    CheckCurrentIncidentsModal,
)
from slack.views.modals.opening.details.normal import (
...
from slack.views.modals.opening.types import (
    NormalIncidentTypes,
    OpeningData,
    ResponseType,
)
...
class OpenModal(SlackModal):
    ...
    def get_set_impact_blocks(
        ...
        from slack.views.modals.opening.select_impact import (  # noqa: PLC0415
            SelectImpactModal,
        )
    ...
    def get_details_modal_form_class(
        ...
        if (
            ...
            from slack.views.modals.opening.details.critical import (  # noqa: PLC0415
