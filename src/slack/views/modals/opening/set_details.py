...
from incidents.signals import create_incident_conversation
...
from slack.views.modals.opening.types import OpeningData
...
class SetIncidentDetails(ModalForm[T], Generic[T]):
    ...
    def handle_modal_fn(  # type: ignore
        ...
        if skip_form:
            return
        # ruff: noqa: PLC0415
        from slack.views.modals.open import modal_open
