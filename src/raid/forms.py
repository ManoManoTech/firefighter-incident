...
from jira_app.client import (
    JiraAPIError,
    JiraUserNotFoundError,
)
from raid.client import client as jira_client
from raid.messages import (
    SlackMessageRaidComment,
    SlackMessageRaidCreatedIssue,
    SlackMessageRaidModifiedIssue,
)
from raid.models import JiraTicket, JiraUser, RaidArea
from raid.service import (
...
if TYPE_CHECKING:
    ...
    from raid.types import JiraObject
