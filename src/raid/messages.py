...
if TYPE_CHECKING:
    ...
    from raid.models import JiraTicket, JiraUser, QualifierRotation
        ...
        return [
            ...
            SectionBlock(
                fields=[
                    ...
                    MarkdownTextObject(
                        text=f":jira_new: *URL:*\nhttps://manomano.atlassian.net/browse/{self.jira_ticket_key}"
                    ),
                ]
            ),
        ]
...
class SlackMessageRaidShowHelp(SlackMessageSurface):
    """Imported from RAID https://git.manomano.tech/qraft/raid/-/blob/master/models/slack/messages/showHelp.json ."""
...
class SlackMessageRaidSingleMessageAction(SlackMessageSurface):
    """Imported from RAID https://git.manomano.tech/qraft/raid/-/blob/master/models/slack/messages/singleMessageActions.json ."""
