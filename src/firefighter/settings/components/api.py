...
from firefighter.settings.settings_utils import (
    _ENV,
    APP_DISPLAY_NAME,
    BASE_URL,
    FF_VERSION,
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": ["api.permissions.StrictDjangoModelPermissions"],
    "DEFAULT_RENDERER_CLASSES": (
        "rest_framework.renderers.JSONRenderer",
        "api.renderer.CSVRenderer",
        "api.renderer.TSVRenderer",
    ),
...
""",
    ...
    "AUTHENTICATION_WHITELIST": ["api.authentication.BearerTokenAuthentication"],
