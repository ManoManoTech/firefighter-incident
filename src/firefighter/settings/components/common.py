...
from firefighter.settings.settings_utils import _ENV, BASE_DIR, config
from firefighter.sso import link_auth_user
...
MIDDLEWARE: tuple[str, ...] = (
    ...
    "firefighter.middleware.HeaderUser",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
)

ROOT_URLCONF = "firefighter.urls"

WSGI_APPLICATION = "firefighter.wsgi.application"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "firefighter.utils.get_global_context",
            ],
            "loaders": [
                (
...
COMPONENTS = {
    ...
    "libraries": [
        ...
        "components.export_button.export_button",
        "components.form.form",
        "components.form_field.form_field",
