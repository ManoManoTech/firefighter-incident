...
from firefighter.tables_utils import BASE_TABLE_ATTRS
from incidents.models import Component, Incident
from incidents.models.incident import IncidentStatus
