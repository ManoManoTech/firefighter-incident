...
from firefighter.fields_forms_widgets import (
...
from incidents.models.incident_membership import IncidentMembership, IncidentRole
...
from incidents.models.metric_type import IncidentMetric, MetricType
from incidents.models.milestone_type import MilestoneType
from incidents.models.priority import Priority
from incidents.models.severity import Severity
from incidents.models.user import User
from incidents.signals import incident_closed, incident_created, incident_updated
...
if TYPE_CHECKING:
    ...
    from incidents.models.impact import (
        Impact,  # noqa: F401
        IncidentImpact,  # noqa: F401
    )
    from incidents.models.incident_cost import IncidentCost
    from slack.models import IncidentChannel

    if settings.ENABLE_CONFLUENCE:
        from confluence.models import PostMortem
